  ...
  return (
    <section className="relative w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[697px] mt-[100px]">
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "linear-gradient(-49.0697deg, rgb(221, 161, 82) 0.50989%, rgb(20, 48, 96) 97.455%)" 
        }}
      />
      ...
      <div className="relative z-10 h-full w-full max-w-[1920px] mx-auto px-4 sm:px-8 lg:px-4 xl:px-0">
        ...
        >
          Where aesthetics meet technical precision to create efficient environments.
        </p>
      </div>
    </section>
  );
